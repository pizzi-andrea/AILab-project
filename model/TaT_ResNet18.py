...
DEFAULT_PATH = Path('saved_model/ResNet18')
...
if __name__ == '__main__':
    ...
    model = resnet18(num_classes=43)  #creating resnet
    ...
    plot_grapich(pandas.read_csv(save_path.joinpath('history_acc.csv'), index_col=None), 'epochs',  'ResNet18(Accuracy)', save_path.joinpath('Accuracy.png'), 'epochs', 'accuracy(%)' )
    plot_grapich(pandas.read_csv(save_path.joinpath('history_loss.csv'), index_col=None), 'epochs',  'ResNet18(Loss)', save_path.joinpath('Loss.png'), 'epochs', 'Loss' )