...
input_channels = 64  # Change this value based on the number of channels in your images
stn = SpatialTransformer(input_channels)
input_tensor = torch.randn(64, input_channels, 8, 8)  # Batch of 32 images of size 8x8 with `input_channels` channels
